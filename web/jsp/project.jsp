...
<head>
    ...
    <script>
        function delPInfo(id, name) {
            var confirm = "确认删除项目名为" + name + "的项目以及其所有信息吗"
...
<div id="project">
    ...
    <div id="div4">
        <div id="div5">
            <button value="新增" id="buttonAdd">新增</button>
            <button value="编辑">编辑</button>
        ...
        <div id="div7">
                ...
                <c:forEach items="${lists}" var="list" varStatus="idx">
                    <tr>
                        ...
                        <td>${list.landlinePhone}</td>
                            <%--<td><a href="/project?type=toEdit&id=${list.id}" id="edit">编辑 </a>--%>
                            <%--<td><a href="/project?type=toEdit&id=${list.id}" id="edit" onclick="toEditInfo(${list.id})">编辑 </a>--%>
                        <td><a href="javascript:void(0);" id="edit" onclick="toEditInfo(${list.id})">编辑 </a>
                            <a href="javascript:void(0);" id="del"
                               onclick="delPInfo(${list.id},'${list.projectName}') ">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <div id="pag_box">
                <a id="btn0"></a>
                <input class="fenye" id="pageSize" type="text" size="1" maxlength="2" value="getDefaultValue()"/><a>
