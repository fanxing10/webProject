...
<div id="div02">
    <form action="/expert?type=add" method="post" role="form">
        <div class="div001"><span class="span1">姓名</span></div>
        <div class="div002"> <input type="text" id="name" name="name"></div>
        <div class="div001"><span class="span1">身份证号</span></div>
        <div class="div003"> <input type="text" id="idCard" name="idCard"></div><br>
        ...
        <div class="div002"><select  name="birth" type="text" class="select_time" >
            <option value="">出生年月</option>
        </select></div>
        <div class="div001"><span class="span1">单位</span></div>
        <div class="div003"> <input type="text" id="unit" name="unit"></div><br>
        <div class="div004"><span class="span1">工作部门</span></div>
        <div class="div002"> <input type="text" id="department" name="department"></div>
        <div class="div001"><span class="span1">学科</span></div>
        <div class="div003"> <input type="text" id="subject" name="subject"></div><br>
        <div class="div004"><span class="span1">职务职称</span></div>
        <div class="div002"> <input type="text" id="job" name="job"></div>
        <div class="div001"><span class="span1">研究方向</span></div>
        <div class="div003"> <input type="text" id="sArea" name="sArea"></div><br>
        <div class="div004"><span class="span1">行业分类</span></div>
        <div class="div002"> <input type="text" id="industryCategory" name="industryCategory"></div>
        <div class="div001"><span class="span1">联系电话</span></div>
        <div class="div003"> <input type="text" id="phoneNum" name="phoneNum"></div><br>
        <div class="div004"><span class="span1">邮箱</span></div>
        <div class="div002"> <input type="text" id="email" name="email"></div>
        <div class="div001"><span class="span1">地址</span></div>
        <div class="div003"> <input type="text" id="address" name="address"></div><br>
        <div class="div005">主要成就</div>
        <div class="div006"> <input type="text" id="mainSuccess" name="mainSuccess"></div><br>
        <div class="div005">荣誉奖励</div>
        <div class="div006"> <input type="text" id="honor" name="honor"></div>
        <div id="div03">
            <button id="button01" type="button" onclick="cancel()">取消</button>
            <button id="button02" type="submit" onclick="return checkData()">提交</button>
        </div>
    </form>
</div>
<script>
